...
import SelectOptionWithAvatar from '@/components/selection-option-with-avatar';
                ...
                <Col xs={24} xl={12}>
                    ...
                    >
                        <Form {...formProps} layout='vertical'>
                            ...
                            >
                                <Select placeholder="Please select a sales owner" {...selectProps} options={queryResultUsers.data?.data.map((user) => ({
                                    value: user.id,
                                    label: (
